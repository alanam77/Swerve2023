...
public class StrafeOutAuto extends SequentialCommandGroup {
  /** Creates a new StrafeOutAuto. */
  public StrafeOutAuto(NewSwerveDrivetrain drivetrain, Elevator elevator) {
    ...
    new DriveTime(drivetrain, 0, -0.3 * Constants.MAX_TRANS_METERS_PER_SEC, 0, 2).raceWith(new AutoControlPower(elevator, 0, 0, 73, false)),
