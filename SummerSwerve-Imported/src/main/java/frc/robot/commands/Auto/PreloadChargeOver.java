...
public class PreloadChargeOver extends SequentialCommandGroup {
  /** Creates a new PreloadChargeOver. */
  public PreloadChargeOver(NewSwerveDrivetrain drivetrain, Elevator elevator) {
    ...
    new DriveTime(drivetrain, -0.3 * Constants.MAX_TRANS_METERS_PER_SEC, 0, 0, 5).raceWith(new AutoControlPower(elevator, 0, 0, 75, false)),
